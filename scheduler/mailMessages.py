def getAnnounceMessage(date, location, presenters, footer):
    ...
    message += "The WAI presentations coming Monday (%s) will be held in <strong>room %s</strong> at 16:00.<br><br>\n\n" % (
        date, location)
    for presenter in presenters:
        message += "<strong>%s</strong>: <i>%s</i>\n<br>%s\n\n<br><br>" % (
            presenter["name"], presenter["title"], presenter["abstract"])
    message += "<br>WAI Zoom Meeting, Time: Jun 22, 2020 04:00 PM Amsterdam <br> Join Zoom Meeting <a href='https://vu-live.zoom.us/j/93734318708'>https://vu-live.zoom.us/j/93734318708</a><br>Meeting ID: 937 3431 8708<br> Password: 492324<br><br>"
...
def getRequestMessage(presenters, date, footer):
    ...
    message += "If you are unfamiliar with the WAI, please visit our <a href = 'https://wai.few.vu.nl/'>introduction page</a>.\n"
    ...
    message += "</ul>"
    message += "</li>"
    message += "<li> In any case, the presentation must not be no longer than 20 minutes.</li>\n"
    message += "</ul>\n"
    ...
    message += "<li> The presenter is responsible to timing his/her presentation and for managing discussions. Feel free to cut people short if their questions are irrelevant or if you do not have time to answer them.</li>\n"
    message += "</ul><br>\n"
...
def getNewScheduleMessage(names, footer):
    ...
    message += "<br><br>"
    message += "The 2018 WAI schedule is online now. See the <a href='http://wai.few.vu.nl/schedule/schedule/2018/'>WAI site</a> (http://wai.few.vu.nl/schedule/schedule/2018/) for information\n\n"
    message += "<br>"
...
def getNewPersonalScheduleMessage(name, data, names, footer):
    message = "Dear %s" % name
    message += "<br><br>"
    message += "The new WAI schedule is online now. See the <a href = 'http://wai.few.vu.nl/schedule/schedule/2019/'>WAI site</a> for information.\n\n"
    message += "<br>"
    message += "If you do not know what WAI is or how it works, see <a href = 'https://wai.few.vu.nl/'>WAI info</a> for information.\n\n"
    message += "<br><br>"
    message += "<b>Your presentation is scheduled to be the  %s .\n\n</b>" % data
    message += "<br>"
    message += "If you are not available, contact a colleague to change slots with, and let %s know so I can update the schedule. \n" % names
    message += "<br><br>"
    message += footer
